      ...
      <section className="w-full py-20">
        ...
        <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-6">
          <Card
            ...
            description="We'll collaborate and plan the project together. We'll discuss the project requirements, goals, and objectives. We'll also discuss the project timeline and budget."
          >
            <CanvasRevealEffect
              animationSpeed={5.1}
  ...
  const Card = ({
    ...
    return (
      <div
        ...
        className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 lg:h-[38rem] rounded-3xl h-[30rem] relative"
      >
        ...
        <div className="relative z-20">
          ...
          <h2
            className="text-base dark:text-white  opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-4  font-bold group-hover/canvas-card:text-white group-hover/canvas-card:-translate-y-2 transition duration-200 text-center"
            style={{ color: "#E4ECFF" }}
          >
            {description}
          </h2>
