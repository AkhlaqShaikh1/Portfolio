    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card
          ...
          description="Once the development is complete, I'll deploy the project to a staging server. You can test the project and provide feedback. I'll make the necessary changes based on your feedback."
        >
          <CanvasRevealEffect
            animationSpeed={3}
